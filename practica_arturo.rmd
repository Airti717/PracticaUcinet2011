...
var.test(data_real_tidy$HCT_mean[data_real_tidy$`In-hospital_death` == 0],
         data_real_tidy$HCT_mean[data_real_tidy$`In-hospital_death` == 1])


# hip nula : medias son iguales
# hip alternativa: se indica en alternative = c("two.sided", "less", "greater")
t.test(data_real_tidy$HCT_mean[data_real_tidy$`In-hospital_death`==0],
       data_real_tidy$HCT_mean[data_real_tidy$`In-hospital_death`==1],
       var.equal = TRUE)
