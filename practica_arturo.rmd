...
parameters=c("HR","RespRate","GCS","Bilirubin","NIMAP","MechVent","PaCO2","Choresterol","TropT","Sa02","Lactate","ALP","Urine")
...
pocos_nas = function(x){
  for(i in 1:length(data_tidy)){
    if(contar_nas(x) >= 2000){
      return(FALSE)
    }
    else{
      return(TRUE)
