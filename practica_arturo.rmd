...
Hacemos la selección de las 10 variables considerando aquellas que tienen menos NA's
...
# Basta hacer solo el test de medias ya que dentro de este saldra la solucion del test de varianzas.
...
test_medias(data_real_tidy$HCT_mean) #Aqui aceptamos las medias, así HTC no nos interesa
...
test_medias(data_real_tidy$Platelets_mean) #Aceptamos las medias, así Platelets no nos interesa
