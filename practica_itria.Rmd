...
data_paciente_132539 %<>%  separate(Time, into = c("horas", "min"),sep = ":", convert = TRUE) %>% 
                          transmute(Parameter, Value,Time_min = horas*60 + min)

# Mostramos un resumen con la estructura del conjunto de datos.
